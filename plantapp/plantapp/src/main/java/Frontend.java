...
public class Frontend {
    ...
    public Frontend() {
        ...
        ImageIcon browseIcon = new ImageIcon(getClass().getResource("/icons/browsebuttontester.jpg"));
        Image scaleBrowseIcon = browseIcon.getImage().getScaledInstance(200, 200, Image.SCALE_SMOOTH);
        ImageIcon scaleBrowseIconImage = new ImageIcon(scaleBrowseIcon);

        JButton browseButton = new JButton(scaleBrowseIconImage);
